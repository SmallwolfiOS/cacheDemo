...
- (NSDictionary *)getGroupInfo:(NSInteger)nIndex{
    ...
    UIImage *thumbnail = [UIImage imageWithCGImage:[(ALAssetsGroup*)_assetGroups[nIndex] posterImage]];
                          
    return @{@"name" : [_assetGroups[nIndex] valueForProperty:ALAssetsGroupPropertyName],
             @"count" : @([_assetGroups[nIndex] numberOfAssets]),
             @"thumbnail" : thumbnail?:[self imageNamed:@"actionbar_picture_icon" ofBundle:@"RongCloud.bundle"]
            };
}
